    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="bg-white shadow-md sticky top-0 z-10">
        <div className="container mx-auto flex justify-between items-center px-6 py-4">
          <div className="text-2xl font-bold text-emerald-600">Profile</div>
          <div className="relative">
            <button className="flex items-center space-x-2 bg-gray-100 px-4 py-2 rounded-full hover:bg-gray-200">
              <img
      ...
      <PasswordChangeModal modalRef={changePasswordModalRef} formRef={formModalRef} />
    </div>
  );
};
