...
const MembershipPlans = [
  { duration: "1 Month", price: "$9.99", id: "1m" },
  { duration: "3 Months", price: "$24.99", id: "3m" },
  { duration: "6 Months", price: "$44.99", id: "6m" },
];
...
//     console.log("Redirecting to payment for:", planId);
...
//   };
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <p className="text-gray-600 mb-6 text-center max-w-2xl text-center">
